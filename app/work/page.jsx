...
const projects = [
  ...
  },
  {
    ...
    stack: [{ name: "canva"}, { name: "Photoshop"}, { name: "coreldraw"}],
...
const Work = () => {
  ...
  return (
   <motion.section  id="work"
    ...
    className="min-h-[80vh] mt-32 flex flex-col justify-center py-12 xl:px-0"
   >
      ...
      <MySwiper />
      <marquee bgcolor-accent loop="-1" scrollamount="5" width="100%">
      THANK YOU FOR CHOOSING <span className="text-accent ">CRAFTCODED</span>
   </marquee>
